...
| **OI-flow fade** | `oi-flow-fade` | heavy 5-day call-OI build → underperformance. ⛔ **The shipped rule now measures −0.93%, 29 `lane-exit-day`, p=0.028 — significantly NEGATIVE and BH-surviving.** *(Stale figures retired 2026-08-29: the "+1.21% median, n=906, most robust edge, HIGH" reading was a 2026-07-24 raw-rank baseline, since superseded twice — full-window fix 08-22, live-rule grading 08-29.)* | swing10 | ⛔ **STOOD DOWN — diary-only, emits no candidates** |
