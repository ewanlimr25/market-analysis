...
| `strategies/sc_filters.py` | **S-C R1** (DESIGN/90 §2-§3): F1..F10, C2, Friday-type expiry in [21, 35] nearest t+28, ATM pair at size_late >= 20, σ_hold, wing targets; `evaluate_name` / `select_top` / `funnel_counts` |
