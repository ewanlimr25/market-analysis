...
| File | What's in it |
|---|---|
| [`regression-gate.md`](regression-gate.md) | Full baseline history for invariant #6: current + prior lane baselines, the 2026-08-08 universe-expansion story, the three-part isolation-check protocol (old-code/new-data, maturity-edge cohort split, same-code/old-universe) — which applies to **gate-effectiveness figures as well as lanes**, per the 2026-08-15 crash-guard case — the 2026-08-08 worked example, the MOM_SHORT knowingly-negative rationale, and exit-day counting. |
